...
<iframe onload='javascript:resizeIframe(this);' frameborder="0" align="texttop" width="150px" height="1px" src="https://prehren.shinyapps.io/most-cited-philosophers-wos/" title="Shiny app that allows users to puruse the WoS citation data I recently used to rank the most cited authors in philosophy journals since 1975 at their own leasure." name="viewCategory"></iframe> 
