...
On the whole, this top 100 is quite similar to the original top 100. A few notable differences are that Kant is now #1; David Lewis moves up considerably (from #12 to #7); and Wittgenstein and Nietzsche are out of the top 10. However, given that all of these changes are due to small changes in the relevant mean proportions, I don't think these differences between the two lists are all that meaningful.
