...
Hanging around experimental philosophers at times, I've been asked more than once if I knew which journals are happy to publish XPhi. I usually point people to Li and Zhu (2023), who got the meta-data for all articles published between 2001 and 2020 that are categorized as Experimental Philosophy on PhilPapers, and then generated a top 20 list of journals that have published the most of these articles (their Table 2). It occurs to me, however, that this list could do with an update. Also, there are some factoids Li and Zhu do not report/investigate, but which might nonetheless interest experimental philosophers (looking for a place to publish).
