...
![Figure 1. Topic distributions with major topics (black); <em>k</em> is the total number of topics.]({{site.url}}/something-of-crunch/assets/images/2025-01-01/figure0.png){: width="95%"}
...
<p style="text-align:center; font-size: 0.85em; padding-right: 30px; padding-left: 30px;"><a id="#x1-18r1">Figure 2.</a> Average pairwise cosine similarities over time for our three target words; errorbars show 95\% confidence intervals.</p>
<br>
...
$$D_{T,w} = \frac{1}{n_{\text{after}}} \sum_{t | y_T + <em>o</em><sub>after</sub> < y_t \leq y_T + o_{\text{after}} + r} \cos(w_T, w_t) -\\ \frac{1}{n_{\text{before}}} \sum_{t | y_T - o_{\text{before}} - r \leq y_t < y_T - o_{\text{before}}} \cos(w_T, w_t),$$
...
![Figure 3. Ranking of <em>D</em>-scores for each of our three sub-corpora (target text in red; <em>o</em><sub>before</sub> = <em>o</em><sub>after</sub> = 0; _r_ = 10)]({{site.url}}/something-of-crunch/assets/images/2025-01-01/figure2.png){: width="60%"}
<p style="text-align:center; font-size: 0.85em; padding-right: 30px; padding-left: 30px;">Figure 3. Ranking of <em>D</em>-scores for each of our three sub-corpora (target text in red; <em>o</em><sub>before</sub> = <em>o</em><sub>a</sub> = 0; _r_ = 10)</p>
<br>
...
![Figure 4. Average <em>D</em>-scores over time for each of our three sub-corpora (target text in red; <em>o</em><sub>before</sub> = <em>o</em><sub>after</sub> = 0; _r_ = 10); errorbars show 95% confidence intervals.]({{site.url}}/something-of-crunch/assets/images/2025-01-01/figure3.png){: width="75%"}
<p style="text-align:center; font-size: 0.85em; padding-right: 30px; padding-left: 30px;">Figure 4. Average <em>D</em>-scores over time for each of our three sub-corpora (target text in red; <em>o</em><sub>before</sub> = <em>o</em><sub>after</sub> = 0; _r_ = 10); errorbars show 95% confidence intervals.</p>
<br>
...
![Figure 5. <em>D</em>-scores for different values of <em>o</em><sub>after</sub> (_r_ = 10; target texts in red; average <em>D</em>-score in black).]({{site.url}}/something-of-crunch/assets/images/2025-01-01/figure4.png){: width="95%"}
<p style="text-align:center; font-size: 0.85em; padding-right: 30px; padding-left: 30px;">Figure 5. <em>D</em>-scores for different values of <em>o</em><sub>after</sub> (_r_ = 10; target texts in red; average <em>D</em>-score in black).</p>
<br>
