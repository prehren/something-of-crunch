...
<p float="left">
       ![Figure 1. Topic distributions with major topics (black); <em>k</em> is the total number of topics.]({{site.url}}/something-of-crunch/assets/images/2025-01-01/figure0.png){: width="33%"}
...
![Figure 3. Ranking of <em>D</em>-scores for each of our three sub-corpora (target text in red; <em>o</em><sub>before</sub> = <em>o</em><sub>after</sub> = 0; <em>r</em> = 10)]({{site.url}}/something-of-crunch/assets/images/2025-01-01/figure2NEW.png){: width="60%"}
