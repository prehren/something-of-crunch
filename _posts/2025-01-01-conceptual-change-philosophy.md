...
<table>
       <tr>
           ...
           <td class="thead depvarhead firsttablerow" style="font-weight:bold; font-style:normal;">$n$</td>
       </tr>
       <tr>
...
![Figure 1. Topic distributions with major topics (black); $k$ is the total number of topics.]({{site.url}}/something-of-crunch/assets/images/2025-01-01/figure0.png){: width="95%"}
<p style="text-align:center; font-size: 0.85em; padding-right: 30px; padding-left: 30px;">Figure 1. Topic distributions with major topics (black); $k$ is the total number of topics.</p>
<br>
...
![Figure 3. Ranking of $D$-scores for each of our three sub-corpora (target text in red; $o_{\text{before}} = o_{\text{after}} = 0$; $r = 10$)]({{site.url}}/something-of-crunch/assets/images/2025-01-01/figure2.png){: width="60%"}
<p style="text-align:center; font-size: 0.85em; padding-right: 30px; padding-left: 30px;">Figure 3. Ranking of $D$-scores for each of our three sub-corpora (target text in red; $o_{\text{before}} = o_{\text{after}} = 0$; $r = 10$)</p>
<br>
...
![Figure 4. Average $D$-scores over time for each of our three sub-corpora (target text in red; $o_{\text{before}} = o_{\text{after}} = 0$; $r = 10$); errorbars show 95\% confidence intervals.]({{site.url}}/something-of-crunch/assets/images/2025-01-01/figure3.png){: width="75%"}
<p style="text-align:center; font-size: 0.85em; padding-right: 30px; padding-left: 30px;">Figure 4. Average $D$-scores over time for each of our three sub-corpora (target text in red; $o_{\text{before}} = o_{\text{after}} = 0$; $r = 10$); errorbars show 95\% confidence intervals.</p>
<br>
