...
![Figure 5. <em>D</em>-scores for different values of <em>o</em><sub>after</sub> (<em>r</em> = 10; target texts in red; average <em>D</em>-score in black).]({{site.url}}/something-of-crunch/assets/images/2025-01-01/figure4NEW.png){: width="75%"}
